    ...
    >
      ...
      <div className='flex items-center gap-2 p-3 mt-4 border border-gray-400 dark:border-white/20 rounded-md'>
        ...
        <input
          ...
          className='text-xs placeholder:text-gray-400 outline-none bg-transparent w-full dark:text-white'
        />
          ...
          chats
            ...
            .map((chat) => (
              ...
              <div
                ...
                className='p-2 px-4 dark:bg-[#57317C]/10 bg-slate-50
                border border-gray-300 dark:border-[#80609F]/15 rounded-md
                cursor-pointer flex justify-between items-start group'
              >
      ...
      <div
        ...
        dark:border-white/15 rounded-md cursor-pointer hover:scale-[1.03] transition-all'
      >
